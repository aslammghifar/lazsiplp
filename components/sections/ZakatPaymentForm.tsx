...
export function ZakatPaymentForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-6 rounded-3xl border border-primary-100 bg-white p-6 sm:p-8">
      <h2 className="text-xl font-extrabold tracking-tight text-primary-900">
        Form Pembayaran {jenisLabel}
      </h2>

      <div className="flex flex-col gap-2.5">
        <label htmlFor="zakat-nominal" className="text-sm font-medium text-primary-900">
      ...
      <div className="flex flex-col gap-4 sm:flex-row">
        <div className="flex flex-1 flex-col gap-1.5">
          <label htmlFor="zakat-nama" className="text-sm font-medium text-primary-900">
            Nama
          </label>
          <input
            id="zakat-nama"
        ...
        <div className="flex flex-1 flex-col gap-1.5">
          <label htmlFor="zakat-kontak" className="text-sm font-medium text-primary-900">
            Nomor WhatsApp
          </label>
          <input
            id="zakat-kontak"
      ...
      <label className="flex items-center gap-3">
        ...
        />
        <span className="text-sm text-primary-800/80">Sembunyikan nama saya (zakat sebagai Hamba Allah)</span>
      </label>
